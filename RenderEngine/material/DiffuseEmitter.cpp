...
optix::Material DiffuseEmitter::getOptixMaterial(optix::Context & context)
{
    ...
    {
        optix::Program radianceProgram = context->createProgramFromPTXFile(getPtxFile("material/DiffuseEmitter.ptx"), "closestHitRadiance");
        ...
        m_optixMaterial->setClosestHitProgram(RayType::PHOTON, context->createProgramFromPTXFile(getPtxFile("material/DiffuseEmitter.ptx"), "closestHitPhoton") );
        m_optixMaterial->setAnyHitProgram(RayType::SHADOW, context->createProgramFromPTXFile(getPtxFile("material/DiffuseEmitter.ptx"), "gatherAnyHitOnEmitter"));
