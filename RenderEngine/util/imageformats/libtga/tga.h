...
static char* tga_error_strings[] = { "Success",     "Error",       "Out of memory", "Failed to open file",
                                     "Seek failed", "Read failed", "Write failed",  "Unknown sub-format" };
...
size_t TGAReadScanlines __P((TGA * tga, tbyte* buf, size_t sln, size_t n, tuint32 flags));
...
size_t TGAWriteScanlines __P((TGA * tga, tbyte* buf, size_t sln, size_t n, tuint32 flags));
