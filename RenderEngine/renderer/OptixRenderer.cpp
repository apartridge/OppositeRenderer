...
void OptixRenderer::initialize(const ComputeDevice & device)
{
    ...
    {
        Program generatorProgram = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/RayGeneratorPPM.ptx"), "generateRay" );
        Program exceptionProgram = m_context->createProgramFromPTXFile(getPtxFile("renderer/ppm/RayGeneratorPPM.ptx") , "exception" );
        Program missProgram = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/RayGeneratorPPM.ptx"), "miss" );
    ...
    {
        Program generatorProgram = m_context->createProgramFromPTXFile( getPtxFile("renderer/pt/RayGeneratorPT.ptx"), "generateRay" );
        Program exceptionProgram =  m_context->createProgramFromPTXFile( getPtxFile("renderer/pt/RayGeneratorPT.ptx"), "exception" );
    ...
    {
        Program generatorProgram = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/PhotonGenerator.ptx"), "generator" );
        Program exceptionProgram = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/PhotonGenerator.ptx"), "exception" );
        Program missProgram = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/PhotonGenerator.ptx"), "miss");
    ...
    {
        Program program = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/UniformGridPhotonInitialize.ptx"), "kernel" );
...
#if ENABLE_PARTICIPATING_MEDIA
    {
        ...
        photonSpheres->setIntersectionProgram(m_context->createProgramFromPTXFile(getPtxFile("renderer/ppm/VolumetricPhotonSphere.ptx"), "intersect"));
        photonSpheres->setBoundingBoxProgram(m_context->createProgramFromPTXFile(getPtxFile("renderer/ppm/VolumetricPhotonSphere.ptx"), "boundingBox"));

        optix::Material material = m_context->createMaterial();
        material->setAnyHitProgram(RayType::VOLUMETRIC_RADIANCE, m_context->createProgramFromPTXFile(getPtxFile("renderer/ppm/VolumetricPhotonSphereRadiance.ptx"), "anyHitRadiance"));
    ...
    {
        Program program = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/VolumetricPhotonInitialize.ptx"), "kernel" );
    ...
    //
    {
        Program program = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/IndirectRadianceEstimation.ptx"), "kernel" );
    ...
    //
    {
        Program program = m_context->createProgramFromPTXFile( getPtxFile("renderer/ppm/DirectRadianceEstimation.ptx"), "kernel" );
...
void OptixRenderer::initDevice(const ComputeDevice & device)
{
    ...
    {
        throw std::runtime_error("Did not find OptiX device Number for given device. OptiX may not support this device.");
    }
}
...
void OptixRenderer::resizeBuffers(unsigned int width, unsigned int height)
{
    ...
    m_randomStatesBuffer->setSize(std::max((unsigned int)PHOTON_LAUNCH_WIDTH, 1280U), std::max((unsigned int)PHOTON_LAUNCH_HEIGHT, 768U));
