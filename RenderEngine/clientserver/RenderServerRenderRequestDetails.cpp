...
QDataStream& operator<<(QDataStream& out, const RenderServerRenderRequestDetails& details)
{
    ...
    str << details.getCamera() << details.getSceneName() << (quint32)details.getRenderMethod()
        << (quint32)details.getWidth() << (quint32)details.getHeight() << (double)details.getPPMAlpha();
